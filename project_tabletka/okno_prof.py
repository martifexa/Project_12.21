...
class Ui_MainWindow_prof(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setStyleSheet("background-image: url(Screenshot_8.png);")
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("Screenshot_8.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(420, 300, 61, 61))
        self.label_3.setStyleSheet("background-image: url(Screenshot_7.png);")
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("Screenshot_7.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(370, 60, 61, 61))
        self.label_4.setStyleSheet("background-image: url(Screenshot_9.png);")
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap("Screenshot_9.png"))
        self.label_4.setScaledContents(True)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(430, 140, 51, 51))
        self.label_5.setStyleSheet("background-image: url(Screenshot_6.png);")
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("Screenshot_6.png"))
