...
class Ui_MainWindow_reg(object):
    def setupUi(self, MainWindow):
        ...
        self.label_9.setStyleSheet("background-image: url(Screenshot_11.png);")
        self.label_9.setText("")
        self.label_9.setPixmap(QtGui.QPixmap("Screenshot_11.png"))
        self.label_9.setScaledContents(True)
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(30, 60, 61, 51))
        self.label_10.setStyleSheet("background-image: url(Screenshot_6.png);")
        self.label_10.setText("")
        self.label_10.setPixmap(QtGui.QPixmap("Screenshot_6.png"))
        self.label_10.setScaledContents(True)
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(20, 390, 61, 51))
        self.label_11.setStyleSheet("background-image: url(Screenshot_7.png);")
        self.label_11.setText("")
        self.label_11.setPixmap(QtGui.QPixmap("Screenshot_7.png"))
        self.label_11.setScaledContents(True)
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(270, 350, 71, 51))
        self.label_12.setStyleSheet("background-image: url(Screenshot_10.png);")
        self.label_12.setText("")
        self.label_12.setPixmap(QtGui.QPixmap("Screenshot_10.png"))
        self.label_12.setScaledContents(True)
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(460, 390, 61, 51))
        self.label_13.setStyleSheet("background-image: url(Screenshot_5.png);")
        self.label_13.setText("")
        self.label_13.setPixmap(QtGui.QPixmap("Screenshot_5.png"))
        self.label_13.setScaledContents(True)
        self.label_13.setObjectName("label_13")
        self.label_14 = QtWidgets.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(700, 330, 51, 51))
        self.label_14.setStyleSheet("background-image: url(Screenshot_2.png);")
        self.label_14.setText("")
        self.label_14.setPixmap(QtGui.QPixmap("Screenshot_8.png"))
        self.label_14.setScaledContents(True)
        self.label_14.setObjectName("label_14")
        self.label_15 = QtWidgets.QLabel(self.centralwidget)
        self.label_15.setGeometry(QtCore.QRect(690, 10, 61, 51))
        self.label_15.setStyleSheet("background-image: url(Screenshot_1.png);")
        self.label_15.setText("")
        self.label_15.setPixmap(QtGui.QPixmap("Screenshot_1.png"))
        ...
        self.label_18.setGeometry(QtCore.QRect(90, 180, 111, 16))
        font = QtGui.QFont()
        font.setUnderline(True)
